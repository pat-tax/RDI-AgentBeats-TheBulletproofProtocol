...
- **Assisted workflow skills**: Claude Code skills (`generating-interactive-userstory-md`, `generating-prd-md-from-userstory-md`) guide users through UserStory → PRD → implementation
